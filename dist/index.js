...
var Tag = function Tag(props) {
  var children = props.children,
      ...
      color = props.color;
  var tag = React__default.createRef();
  ...
  }, children, closable && React__default.createElement("span", {
    className: 'closeBtn',
    onClick: handleClose
  }, "x"));
};
...
var Empty = function Empty(props) {
  ...
  }), React__default.createElement("p", null, text ? text : '空空如也')));
};
...
var Alert = function Alert(props) {
  ...
  return visible ? React__default.createElement("div", {
    ...
    className: "alertDesc"
  }, description), !!closable && React__default.createElement("span", {
    className: "closeBtn",
    onClick: handleClose
